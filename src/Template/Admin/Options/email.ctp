...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#notifications" aria-controls="notifications" role="tab"
                                   data-toggle="tab"><?= __('Notifications') ?></a></li>
    </ul>
    ...
    <div class="tab-content">
        <div role="tabpanel" id="settings" class="tab-pane fade in active">
            ...
            <div class="row conditional" data-cond-option="Options[<?= $settings['email_method']['id'] ?>][value]"
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['email_smtp_security']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'none' => __('None'),
                            'ssl' => __('SSL'),
        ...
        <div role="tabpanel" id="notifications" class="tab-pane fade in">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['alert_admin_new_user_register']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No')
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['alert_admin_new_withdrawal']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No')
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['alert_admin_created_invoice']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No')
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['alert_admin_paid_invoice']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No')
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['alert_member_approved_withdraw']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No')
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->input('Options.' . $settings['alert_member_completed_withdraw']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No')
